document.addEventListener('DOMContentLoaded', () => {
    ...
    componentes.forEach(componente => {
        ...
        let titulos = componente.parentElement.textContent.trim();
        ...
        if(titulo.textContent == "Procesador"){
            ...
            else if(titulos.textContent =="Fuente"){
            ...
            else if(titulos.textContent =="Motherboard"){
            ...
            else if(titulos.textContent =="Disco SSD"){
            ...
            else if(titulos.textContent =="RAM"){
